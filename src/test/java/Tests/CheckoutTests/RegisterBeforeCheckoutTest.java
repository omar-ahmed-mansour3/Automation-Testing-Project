...
public class RegisterBeforeCheckoutTest extends CheckoutTestBase {
    ...
    public void registerBeforeCheckoutTest(RegisterAndCheckoutData data){
        ...
        // ************** Payment **************
        PaymentDonePage paymentDonePage = placeOrderAndPay(checkoutPage,
                "bla bla 123 !@#$%", data);
